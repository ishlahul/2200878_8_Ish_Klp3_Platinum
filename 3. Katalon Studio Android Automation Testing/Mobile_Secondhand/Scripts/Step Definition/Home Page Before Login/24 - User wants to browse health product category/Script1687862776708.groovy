...
WebUI.callTestCase(findTestCase('Pages/Home Before Login/Tap Button Kesehatan'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('Page_Product/Category/text_Kesehatan'), FailureHandling.STOP_ON_FAILURE)
