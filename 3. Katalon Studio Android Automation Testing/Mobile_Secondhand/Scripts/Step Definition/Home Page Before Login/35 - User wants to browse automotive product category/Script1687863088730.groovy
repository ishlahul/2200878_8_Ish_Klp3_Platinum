...
WebUI.callTestCase(findTestCase('Pages/Home Before Login/Tap Button Otomotif'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('Page_Product/Category/text_Otomotif'), FailureHandling.STOP_ON_FAILURE)
