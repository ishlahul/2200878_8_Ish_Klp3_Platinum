...
WebUI.callTestCase(findTestCase('Pages/Home Before Login/Tap Button Fashion Muslim'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('Page_Product/Category/text_Fashion Muslim'), FailureHandling.STOP_ON_FAILURE)
