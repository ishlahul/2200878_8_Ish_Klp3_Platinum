...
WebUI.callTestCase(findTestCase('Pages/Create Akun/Input Nomor Hp'), [('nomor_hp') : '0812804230423'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Create Akun/Input Kota'), [('kota') : 'Semarang'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Create Akun/Input Alamat'), [('alamat') : 'Tembalang'], FailureHandling.STOP_ON_FAILURE)
