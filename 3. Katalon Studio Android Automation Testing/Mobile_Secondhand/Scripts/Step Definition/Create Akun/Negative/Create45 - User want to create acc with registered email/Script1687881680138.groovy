...
WebUI.callTestCase(findTestCase('Pages/Create Akun/Input Email Neg TC'), [('email_user') : 'jeno111@yopmail.com'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Create Akun/Verify Content Neg'), [:], FailureHandling.STOP_ON_FAILURE)
