...
WebUI.callTestCase(findTestCase('Pages/Create Akun/Input Email Neg TC'), [('email_user') : 'jenolee'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Create Akun/Verify email invalid'), [:], FailureHandling.STOP_ON_FAILURE)
