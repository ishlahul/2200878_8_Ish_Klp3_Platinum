...
WebUI.callTestCase(findTestCase('Pages/Add_Product/Input product description'), [('product_desc') : '123'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Add_Product/Choose file'), [:], FailureHandling.STOP_ON_FAILURE)
