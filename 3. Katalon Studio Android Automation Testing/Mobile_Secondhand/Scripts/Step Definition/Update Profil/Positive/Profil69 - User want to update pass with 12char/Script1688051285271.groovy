...
Mobile.callTestCase(findTestCase('Pages/Login/Input Password'), [('password') : 'yuta26'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Pass Lama'), [('pass_lama') : 'yuta26'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Pass Baru'), [('pass_baru') : 'yuta1234yuta'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Konfirm Pass'), [('pass_konfirm') : 'yuta1234yuta'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Tap Button Simpan'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Verify Content Pass'), [:], FailureHandling.STOP_ON_FAILURE)
