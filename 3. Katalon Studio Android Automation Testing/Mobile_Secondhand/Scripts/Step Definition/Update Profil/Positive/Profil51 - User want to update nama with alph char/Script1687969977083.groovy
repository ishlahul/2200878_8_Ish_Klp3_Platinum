...
Mobile.callTestCase(findTestCase('Pages/Update Profil/Update Nama'), [('update_nama') : 'lee jeno'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementNotVisible(findTestObject('Page_UpdateProfil/TextView - Ubah Nama'), 0)
