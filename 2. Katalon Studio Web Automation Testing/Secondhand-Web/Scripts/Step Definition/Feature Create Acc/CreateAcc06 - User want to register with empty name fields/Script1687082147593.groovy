...
WebUI.callTestCase(findTestCase('Pages/Create Acc/Input Nama'), ['user_name' : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Create Acc/Input Email Negative'), ['user_email' : 'ayyo@yopmail.com'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Create Acc/Input Password'), ['user_password' : 'aespa1234'], FailureHandling.STOP_ON_FAILURE)
