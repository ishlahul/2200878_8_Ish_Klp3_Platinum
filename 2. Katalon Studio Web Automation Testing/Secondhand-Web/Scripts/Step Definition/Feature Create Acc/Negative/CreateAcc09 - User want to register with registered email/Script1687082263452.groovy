...
WebUI.setText(findTestObject('Page_HomeCreateAcc/input_Email_useremail'), 'karina120@yopmail.com')
...
WebUI.verifyElementPresent(findTestObject('Page_HomeCreateAcc/div_Email has already been taken'), 0)
