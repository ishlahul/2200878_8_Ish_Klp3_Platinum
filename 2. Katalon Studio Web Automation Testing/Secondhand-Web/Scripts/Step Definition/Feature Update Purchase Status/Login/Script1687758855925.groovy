...
WebUI.callTestCase(findTestCase('Pages/Login/Input Email'), [('email') : 'lestariasyifa98@gmail.com'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Login/Input Password'), [('password') : 'paulina2020,'], FailureHandling.STOP_ON_FAILURE)
