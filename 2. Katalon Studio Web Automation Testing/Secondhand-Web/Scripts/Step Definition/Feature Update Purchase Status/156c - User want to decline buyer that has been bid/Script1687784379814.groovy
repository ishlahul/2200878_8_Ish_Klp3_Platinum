...
WebUI.callTestCase(findTestCase('Pages/Offers/Click Button Tolak'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Offers/Verify Decline Offers'), [:], FailureHandling.STOP_ON_FAILURE)
