...
WebUI.callTestCase(findTestCase('Pages/Add Product/Input Product Name'), [('product_name') : 'skuter'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Add Product/Upload Product'), [('upload_file') : 'skuter.png'], FailureHandling.STOP_ON_FAILURE)
