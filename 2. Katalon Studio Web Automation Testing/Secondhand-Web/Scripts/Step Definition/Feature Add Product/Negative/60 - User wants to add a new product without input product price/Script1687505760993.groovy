...
WebUI.callTestCase(findTestCase('Pages/Add Product/Choose Product Category'), [('product_cat') : '1', ('isRegex') : true], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Add Product/Input Product Description'), [('product_desc') : 'isi'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Add Product/Upload Product'), [('upload_file') : 'sepeda.jpg'], FailureHandling.STOP_ON_FAILURE)
