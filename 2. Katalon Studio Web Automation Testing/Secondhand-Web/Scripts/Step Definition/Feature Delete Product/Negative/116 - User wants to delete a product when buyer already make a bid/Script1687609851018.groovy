...
WebUI.callTestCase(findTestCase('Pages/Delete Product/Click Delete Product'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Delete Product/Verify Content'), [:], FailureHandling.STOP_ON_FAILURE)
